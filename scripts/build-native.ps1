...
try {
    ...
    foreach ($marker in @('1.2.0-candidate.4', '3.4.0-native.12', $url, 'exchange_walker_live', 'f2t_factory_parse_display', 'f2t_depot_parse_display', 'company.depot.read', 'company.depot.transfer', 'prepareTransfer')) {
