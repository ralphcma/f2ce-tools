...
function EW.ui.registerMuxContent()
  ...
  local definition = {
    ...
    resize = function(target)
      if EW.ui.refreshMounted then EW.ui.refreshMounted(target, false)
      elseif EW.ui.reflowTable then EW.ui.reflowTable(target, false)
    ...
    onReveal = function(target)
      if EW.ui.refreshMounted then EW.ui.refreshMounted(target, true)
      elseif EW.ui.reflowTable then EW.ui.reflowTable(target, true) else update_ui() end
    end,
  }
